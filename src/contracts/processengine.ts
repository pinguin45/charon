...
export interface IProcessEngineRepository {
  ...
  getProcessesByProcessDefId(processDefId: string, limit: number, offset: number): Promise<IPagination<IProcessEntity>>;
  ...
  getUserTasksByProcessDefId(processDefId: string, limit: number, offset: number): Promise<IPagination<IUserTaskEntity>>;
  getUserTasksByProcessId(processId: string, limit: number, offset: number): Promise<IPagination<IUserTaskEntity>>;
